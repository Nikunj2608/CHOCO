    ...
    return (
        <MaxWidthWrapper>
            <div className='text-center space-y-5 my-14' id='testimonials'>
                ...
                <h2 className='font-semibold text-xl'>Hear from our satisfied customers about their experience with our services.</h2>
            </div>
                ...
                <li className='break-inside-avoid'>
                    <figure className="relative h-full w-full max-w-[500px] p-6 rounded-xl border border-gray-200">
                        <blockquote className='border-b pb-4 font-semibold text-lg'>
                            I Can't stop Licking Chreeish Icecreams
                        </blockquote>
                        <figcaption>
                            <div className='flex items-center gap-4 mt-4'>
                                ...
                                <div className="flex flex-col">
                                    <p className='font-semibold'>Nikuji</p>
